...
//			--> the index bucket conains the first known entry for each term, which is used to reduce the number of failed AppendEntryRPCs when a node is brought into the cluster and being synced back to the leader
